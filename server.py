...
# ---- 1. 后台启动业务微服务 ----
# 【核心修改点】：将原来的 order_service / product_service / logistics_service 
# 替换成了你自己项目的 ticket_service / device_service / network_service
import services.ticket_service as s_ticket
import services.device_service as s_device
import services.network_service as s_network
...
# 分别启动你的 3 个微服务
for m in (s_ticket, s_device, s_network):
    _start(m)
time.sleep(0.8)
